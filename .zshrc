...
#shopt gives errors
shopt -s autocd &>/dev/null #Allows you to cd into directory merely by typing the directory name.
...
# export MANPATH="/usr/local/man:# You may need to manually set your language environment
